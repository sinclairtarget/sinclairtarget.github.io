...
year: 2000
description: >
    What can we learn about REST APIs by reading the original REST proposal?
---
...
to be so widely misunderstood. <!--more-->
...
kind of standard way of doing things. Since everyone was using HTTP, and since
...
FIOH APIs and advertising them, with a nudge and a wink, as REST APIs, then of
