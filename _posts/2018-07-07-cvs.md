...
excerpt: >
    ...
    learning curve or intuitive interface, Git has become everyone's go-to
...
intuitive interface, Git has become everyone's go-to for version control. In
...
conceiving of a world where the term "version control software" didn't just
mean Git, such a world existed not so long ago. There were lots of alternatives
to choose from. Open source developers preferred Subversion, enterprises and
video game companies used Perforce (some still do), while the Linux kernel
project famously relied on a version control system called BitKeeper.
...
nobody has used in the last decade.
